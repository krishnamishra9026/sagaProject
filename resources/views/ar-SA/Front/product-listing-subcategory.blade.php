    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-10 col-md-10">
                <div class="row pb-3">
                    <div class="col-12 pb-1">
                            ...
                            <div class="col-md-12 text-md-right text-center">
                                <div class="btn-group" style="float: left;">
                                    <select class="btn btn-sm btn-light ml-1" id="short_by">
                                        <option>@if(session('locale')=='en') Sort by @else   فرز حسب   @endif </option>
                        ...
                        <div class="tab-pane active" id="view4" >
                            <div class="row" id="Result" style="direction: rtl;">
                            </div>
                        </div>
                    </div>
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="d-inline-block bg-secondary pr-3">@if(session('locale')=='en') Price Filter @else      فرز حسب السعر       @endif</span></h5>
                <div class="bg-light d-flex p-4 mb-30" style="height: 80px">
                  <button class="btn btn-primary btn-sm mr-1" type="submit" style="width: 30%; float: right;" onclick="Search()">@if(session('locale')=='en') APPLY @else  تطبيق    @endif </button>
                    <input type="text" name="fromVal" class="fromVal" id="fromVal" style="width: 100%; float: left;" placeholder="ريال سعودي">-
                    <input type="text" name="toVal" class="toVal" id="toVal" style="width: 100%; " placeholder="ريال سعودي">
                </div>
                <!-- <div class="bg-light p-4 mb-30">
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="d-inline-block bg-secondary pr-3">@if(session('locale')=='en') New Arrivels @else      وصل حديثا     @endif </span></h5>
                <div class="bg-light p-4 mb-30">
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <a href="{{route('DemoSingleProduct',['id'=>$row->id])}}" class="btn btn-outline-dark btn-square" href="Javascript:void(0);"><i class="fa fa-eye"></i></a>
                            ...
                            <div class="text-center py-4 pl-2 pr-2">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{ isset($row->discount_price) ? $row->discount_price : ''}} <!--SAR-->     ريال سعودي </h5>
                                    <h6 class="text-muted  ml-2"><del>{{ isset($row->price) ? $row->price : ''}} <!--SAR-->      ريال سعودي   </del></h6>
                                </div>
...
function loadData(page){
  ...
  $.ajax(
  {
    url : siteurl+'/ar-SA/ProductListingBySlug',
    type: "POST",

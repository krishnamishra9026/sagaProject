                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
	                        <div class="form-group">
	                            ...
	                            <input class="form-control" type="text" placeholder="Phone (optional)">
	                        </div>
                        </div>
                    ...
                    <div class="table-responsive checkoutPrd_listing">
                    	<table class="w-100">
                    		...
                    		<tr>
                    			...
                    			<th width="">
                    				<h2>{{ isset($subcategory->name) ? $subcategory->name : '' }} @if(session('locale')=='en')  from saga @else من الملحمة  @endif</h2>
                    	...
                    	<table class="w-100 mt-3">
                    		<tr>
                    			...
                    			<td class="text-right text-dark">{{ \Cart::getTotal() }} ريال سعودي</td>
                    		</tr>
                    		<!-- <tr>
                    	...
                    	<table class="w-100 mt-3">
                    		<tr>
                    			...
                    			<td class="text-right text-dark"><h3>{{ round(\Cart::getTotal()).'.00' }} ريال سعودي</h3></td>
                    		</tr>
                    	</table>
                        <input type="hidden" name="productname" value="{{ isset($subcategory->name) ? $subcategory->name : '' }}">
                            ...
                            <div class="col p-0">
                                <!--<a href="#" class="btn btn-block btn-primary font-weight-bold py-2">@if(session('locale')=='en') Pay Now @else ادفع الآن   @endif</a>-->
                                <button name="submit" class="btn btn-block btn-primary font-weight-bold py-2">@if(session('locale')=='en') Pay Now @else ادفع الآن   @endif</button>
                            </div>
                        </form>
                    </div>                    
                </div>

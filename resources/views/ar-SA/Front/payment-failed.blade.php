        ...
        <div class="col-md-12">
            <div class="card mb-5" style="width: 400px;text-align: center;box-shadow: none;max-width: 100%;margin: 28px auto 0;font-size: 35px;border: 0;">
                <div class="alert alert-danger mb-0 pb-5">
                        ...
                        <h1 style="color: #000;margin: 68px 0 27px;font-size: 25px;"> <br><span style="font-size: 16px;">Your payment is Not successfully Processed, TRY AGAIN!!!</span></h1>
                        <a href="{{ route('Home') }}}" class="btn btn-danger text-white">Back to Payment Page</a> 
                </div>
            </div>
        </div>
    </div>

...
<section class="categories_sec">
    <div class="container-fluid pt-5"> 
        ...
        <div class="row px-xl-5 pb-3" style="direction: rtl;">
            <?php
                ...
                <a class="text-decoration-none" href="{{route('ProductListingOfSubcategory',['id'=>$row->id])}}">
                    <div class="cat-item align-items-center mb-4">
                        ...
                        <div class="flex-fill pl-3">
                            ...
                            <!--<small class="text-body">{{ isset($procount->total) ? $procount->total : '' }}   @if(session('locale')=='en')  Products @else  تجات@endif  </small>-->
                        </div>
...
<section class="prd_listing">
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
            <!--<span class="bg-secondary pr-3">@if(session('locale')=='en')  New Product @else  تجات جديدة  @endif </span>-->
        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 pb-1">
                <div class="owl-carousel home_prd_carousel_LtoR">
                    <?php
                    foreach ($NewProduct as $row) { ?>
                       <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4 pl-2 pr-2">
                            ...
                            ?>
                            <h2 class="h4"><a class="text-dark text-decoration-none text-truncate" href="{{route('DemoSingleProduct',['id'=>$row->id])}}"><?php echo isset($subcategoryname->name) ? $subcategoryname->name : $categoryname->category_name ?> @if(session('locale')=='en')  @else       @endif  </a></h2>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $row->discount_price?>       ريال سعودي</h5>
                            <h6 class="text-muted mr-2"><del><?php echo $row->price?>      ريال سعودي </del></h6>
                            </div>
...
<section class="prd_listing">
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
            ...
            <a href="{{route('ProductListingOfSubcategory',['id'=>$row->id])}}" class="btn btn-primary float-right">@if(session('locale')=='en') View All @else    عرض الكل       @endif</a>
        </h2>
                ...
                <div class="owl-carousel home_prd_carousel_LtoR">
                   ...
                   ?>
                    <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <form action="{{ route('cart.store') }}" method="POST">
                                        ...
                                        <input type="hidden" value="{{asset('images/products/'.$list->image)}}"  id="img" name="img">
                                        <?php
                                        $productPrice = 0;
                            ...
                            <div class="text-center py-4 pl-2 pr-2">
                                <h2 class="h4"><a class="text-dark text-decoration-none text-truncate" href="{{route('DemoSingleProduct',['id'=>$list->id])}}">{{ $row->name }} @if(session('locale')=='en')  @else     @endif </a></h2>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{ $list->discount_price }} <!--SAR--> ريال سعودي </h5>
                                    <h6 class="text-muted mr-2"><del>{{ $list->price }} <!--SAR-->  ريال سعودي </del></h6>
                                </div>
...
<section class="saga_imag pt-5">
    <div class="container-fluid py-5">
        <h2 class="section-title text-center position-relative text-uppercase mx-xl-5 mb-4">
            <span class="bg-secondary pl-3 pr-3">@if(session('locale')=='en')  Saga Photo Album @else   البوم الصور        @endif </span>
        </h2>

        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel vendor-carousel-LtoR">
        ...
        <div class="row px-xl-5 pb-3">
            <!--<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">@if(session('locale')=='en')  Free Shipping @else   شحن مجاني      @endif </h5>
                </div>
            </div>-->
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <img src="{{asset('images/icon3.png')}}" alt="" class="ml-3">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <img src="{{asset('images/icon2.png')}}" alt="" class="ml-3">
                    <h5 class="font-weight-semi-bold m-0">@if(session('locale')=='en')  Secure Payment @else   الدفع الآمن      @endif </h5>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <img src="{{asset('images/icon1.png')}}" alt="" class="ml-3">

...
<section class="prd_single_page">   
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30 prd_right">
                    ...
                    <table class="table-bordered table">
                        <tr>
                            <td>@if(session('locale')=='en')  Product SKU @else المنتج SKU م@endif</td>
                            <td>{{ isset($productDetails->sku_id) ? $productDetails->sku_id : '' }}</td>
                        </tr>
                        <tr>
                            <td>@if(session('locale')=='en')  Availability @else التوفر م@endif</td>
                            <td>{{ (isset($productDetails->in_stock) &&  $productDetails->in_stock=='Yes') ? 'In Stock' : 'Out of Stock' }}</td>
                        </tr>
                    </table>
                    ...
                    <form action="{{ route('cart.store') }}" method="POST">
                        ...
                        ?>
                        <h2 class="font-weight-semi-bold d-inline-block mr-3">
                            @if(session('locale')=='en')  Price @elseسعر ا@endif: 
                            <span class="h4" id ="ShowGetGstValue"></span><span  class="h4" id ="ShowOldGetGstValue">{{ isset($ProductPriceWithGst) ? $ProductPriceWithGst : '' }} </span>  <span class="h4">SAR</span>
                            <h6 class="text-muted d-inline-block mr-3"><del> {{ isset($productDetails->price) ? $productDetails->price : '' }} SAR</del></h6>
                        </h2>
                        <input type="hidden" value="{{ isset($ProductPriceWithGst) ? $ProductPriceWithGst : '' }}" id="price" name="price">
                        
                        <div class="d-flex mb-2">
                            <strong class="text-dark mr-3">@if(session('locale')=='en')  Colors @else  الألوان م@endif :</strong>
                            <ul class="colorOptions" style="font-weight: 400; padding-left: 0px;">
                        ...
                        <div class="d-flex mb-3">
                            <strong class="text-dark mr-3">@if(session('locale')=='en')  Sizes @else الأحجام م@endif:</strong>
                            <ul class="sizeOptions" style="font-weight: 400; padding-left: 0px;">
                        ...
                        <ol style="font-weight: 400; padding-left: 0px;"> 
                            <?=isset($productDetails->short_discription) ? $productDetails->short_discription : '' ?>
                        </ol>

                        <div class="d-flex mb-3">
                            <strong class="text-dark mr-3">@if(session('locale')=='en')  Quantity @else  كمية م@endif :</strong>
                        ...
                        <div class="d-flex align-items-center mb-4 pt-2">
                            <button class="btn btn-primary px-3 mr-1 w-100" data-toggle="modal" data-target="#addToCartModal"><i class="fa fa-shopping-cart mr-1"></i>@if(session('locale')=='en')  Add to cart @else  أضف إلى السلة  م@endif </button>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">@if(session('locale')=='en')  Description @else وصف  ر@endif</a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1" style="font-weight: 400;">
                            <h4 class="mb-3">@if(session('locale')=='en')  Product Description @else وصف المنتج  ر@endif</h4>
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 review for "{{ isset($productDetails->name) ? $productDetails->name : '' }}"</h4>
                                    <div class="media mb-4">
                                        <img src="{{ asset('images/user.jpg')}}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>John Doe<small> - <i>01 Jan 2021</i></small></h6>
    ...
    <div class="container-fluid py-5 prd_listing">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">@if(session('locale')=='en')  You May Also Like @else ربما يعجبك أيضا  ك@endif</span></h2>
        <div class="row px-xl-5">
            <div class="col p-0">

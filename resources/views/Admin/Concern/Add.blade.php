...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form action="{{ route('InsertConcern')}}" autocomplete="off"  enctype="multipart/form-data" method="post" id="AddForm" name="AddForm">
                  ...
                  <div class="row">
                   <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="name" name="name" onkeyup="HideErr('concern_msg')">
                   ...
                   <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="concern_slug" name="concern_slug" onkeyup="HideErr('concern_slug_msg')">

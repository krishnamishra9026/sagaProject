...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form action="{{route('InsertMenu')}}" enctype="multipart/form-data" method="post" id="AddMenuPageForm" name="AddForm" >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                   ...
                   <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="slug" value="" name="slug" placeholder="slug" >
                  ...
                  <div class="col-sm-6">
                    <div class="form-group " >
                      ...
                      <textarea class="form-control" value="" id="summernote_page_description" name="page_discription" onchange="HideErr('summernote_product_description_msg')"  ></textarea>

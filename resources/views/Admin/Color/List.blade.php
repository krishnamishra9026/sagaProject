              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="{{route('AddColor')}}">
                    <button type="button" class="btn btn-secondary m-1 pull-right">Add Color</button>
                  </a>
                </div>
              </div>
               <hr>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="FontSize">
                          <a href="{{route('EditColor',['id'=>base64_encode($row->id)])}}">
                            <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                          </a>
                          <a href="{{route('DeleteColor',['id'=>base64_encode($row->id)])}}" onclick="return confirm('Are you sure?')">

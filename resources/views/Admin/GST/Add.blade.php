...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form action="{{ route('InsertGst')}}" enctype="multipart/form-data" method="post" id="AddGSTForm" name="AddForm" >
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="row">
          <div class="col-lg-12 mx-auto">
            <div class="card">
              <div class="card-body">
                <div class="card-title">Add GST</div>
                <hr>
                <span id="Return_msg">
                  <?php
                ...
                <div class="row">
                   ...
                   <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="gst_" name="gst" value="" placeholder="0%"  onchange="HideErr('gst_msg')" > 

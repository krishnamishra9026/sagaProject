              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <a href="{{route('AddCategory')}}">
                    <button type="button" class="btn btn-secondary m-1 pull-right">Add Category</button>
                  </a>
                </div>
              </div>
               <hr>
              ...
              <div class="table-responsive">
                <table class="table"  >
                  <thead class="thead" style="background-color:#16088E;">
                    ...
                    <th class="FontSize text-white ">GST</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="FontSize">{{ $row->category_name}}<br>
                      <td class="FontSize">{{ $row->gst}}%<br>
                      <a class="d-none" href="{{route('AddCategoryInConcern',['id'=>base64_encode($row->id)])}}" data-toggle="tooltip" title="Add Concern" ><i class="fa fa-edit"></i></a>

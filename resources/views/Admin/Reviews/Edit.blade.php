      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('OurCustomers')}}">Our Customers List</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Our Customers</li>
          </ol>
        </div>
      </div>
      
      <form action="{{route('SaveOurCustomers')}}" enctype="multipart/form-data" method="post" id="EditForm" name="EditForm" novalidate="novalidate">
        ...
        <div class="row">
          <div class="col-lg-12 mx-auto">
            <div class="card">
              <div class="card-body">
                <div class="card-title">Edit OurCustomers</div>
                <hr>
                <span id="Return_msg">
                ...
                <div class="row">
                   <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <textarea name="description" class="form-control" id="description">{{$Result->description}}</textarea>
                    </div> 
                  </div>
                </div>

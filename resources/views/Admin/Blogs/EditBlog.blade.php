...
@section('content')
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form action="{{route('SaveBlog')}}"  autocomplete ="off" enctype="multipart/form-data"  method="post" id="EditForm" name="EditForm" >
...
<div class="row mt-2">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="blog_slug" value="{{$Result->blog_title}}"  name="blog_title" placeholder="Name" onkeyup="HideErr('blog_slug_msg')">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="blog_title_display_name"  value="{{$Result->blog_title_display_name}}" id="blog_title_display_name" name="blog_title_display_name" placeholder="Name" onkeyup="HideErr('blog_title_display_name_msg')">
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="summernote" name="blog_description" onkeyup="HideErr('summernote_msg')">{{$Result->blog_description}}</textarea>
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      <label for="input-1">Blogs Images</label>
                      <input type="file" class="form-control" id="Menu_images"  name="images[]" placeholder="Multiple Images" multiple>
                      <img  class="mt-2" style='height:80px; width:120px;' src="{{ url('/images/blog/'. $Result->images)}}">
...
<script type="text/javascript">
   ...
   $(document).ready(function (){
        ...
        $(document).on("blur",'#blog_title_display_name',function(){

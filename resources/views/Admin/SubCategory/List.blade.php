        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <h5 class="card-title">Sub Categories List</h5>
                </div>
                <div class="col-sm-6">
                  <a href="{{route('AddSubCategory')}}">
                    <button type="button" class="btn btn-secondary m-1 pull-right">Add Sub Category</button>
                  </a>
                </div>
              </div>
               <hr>
                ...
                <table class="table"  >
                  <thead class="thead" style="background-color:#16088E;">
                    <tr>
                      ...
                      <th class="FontSize text-white">Sub Category Name</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="FontSize">{{ $row->category_name}}</td>
                      ...
                      <td class="FontSize">
                          <a href="{{route('EditSubCategory',['id'=>base64_encode($row->id)])}}">
                            <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                          </a>
                          <a href="{{route('DeleteSubCategory',['id'=>base64_encode($row->id)])}}" onclick="return confirm('Are you sure?')">

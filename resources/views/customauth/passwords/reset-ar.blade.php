...
<section class="wish_list_page mt-4 pt-5 pb-5">
	<div class="container-fluid">
		<h2 class="section-title position-relative text-center text-uppercase mx-xl-5 mb-4">
			<span class="bg-secondary pr-3">إعادة تعيين كلمة المرور</span>
		</h2>
            ...
            ?>
                ...
                <form method="POST" action="{{ route('postResetPassword') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>@if(session('locale')=='en')  Password @else   كلمه السر    @endif<sup class="text-danger">*</sup></label>
                        <input type="password" class="form-control" name="password" id="password" placeholder="Enter New Password" required>
                        <span id="email_msg"></span>
                      </div>
                      <div class="form-group">
                        <label>@if(session('locale')=='en') Confirm Password @else   تأكيد كلمة المرور      @endif<sup class="text-danger">*</sup>( <span id='message'></span>)</label>
